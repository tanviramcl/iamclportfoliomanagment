<%@ Page Language="C#" MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="HowlaDSEentryForm.aspx.cs" Inherits="UI_HowlaDSEentryForm" Title="Howla DSE Entry Page" %>
    ...
    <script language="javascript" type="text/javascript"> 
     function fnCheqInput()
     {
            ...
            if(document.getElementById("<%=tradeCusFileUpload.ClientID%>").value =="")
            {
                ...
                alert("Please Select 11RT14URT14.........TXT File");
                return false;
            }
     }
     function fnConfirm()
...
<table width="600" align="center" cellpadding="0" cellspacing="0" >
    ...
    <td align="center" class="TableHeader">DSE Howla Entry Form</td>  
    </tr>
</table>
<br />
<br />
      ...
      <td align="left">TradeCus File</td>
        <td align="left">
            <asp:FileUpload ID="tradeCusFileUpload" runat="server" AutoPostBack="True"/>
                &nbsp;<span class="star">TradeStatusTodayBroker_ISTBROKER.TXT</span></td>
