<%@ Page Language="C#" MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="CompanyInfoUpdate.aspx.cs" Inherits="UI_CompanyInfoUpdate" Title="Company Info Update" %>
...
<colgroup width = "180"></colgroup>
        ...
        <td align="left" >
            <asp:DropDownList ID="companyNameDropDownList" runat="server" TabIndex="1">
             ...
             <asp:Button ID="findButton" runat="server" Text="Find" 
                CssClass="buttoncommon" TabIndex="2" 
                OnClientClick=" return fnCheckInput();" onclick="findButton_Click"/>
        </td>
    ...
    <tr>
            ...
            <asp:Button ID="resetButton" runat="server" Text="Reset" 
                CssClass="buttoncommon" TabIndex="49" OnClientClick=" return fnReset();"/>
            </td>
