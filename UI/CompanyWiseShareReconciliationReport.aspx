<%@ Page Language="C#" MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="CompanyWiseShareReconciliationReport.aspx.cs" Inherits="UI_CompanyWiseShareReconciliationReport" Title="Share Reconciliation Page" %>
...
<table style="text-align:center">
    <tr>
        <td class="FormTitle" align="center">
            Share Reconciliation Report Form
        </td>           
        <td>
            <br />
        </td>
